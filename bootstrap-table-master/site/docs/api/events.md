...
- **Detail:**
  ...
  Fires when user check all data, the parameters contain:

  * `rowsAfter`: array of records of the now checked data.
  * `rowsBefore`: array of records of the checked data before.
...
- **Detail:**
  ...
  Fires when user check some data, the parameters contain:

  * `data`: array of records corresponding to newly checked data.
...
- **Detail:**
  ...
  Fires when user uncheck all data, the parameters contain:
...
- **Detail:**
  ...
  Fires when user uncheck some data, the parameters contain:

  * `data`: array of records corresponding to previously checked data.
