...
- **Detail:**
  ...
  * `values`: array of values for data to check.
...
- **Detail:**
  ...
  Invert check of current page data. Triggers `onCheckSome` and `onUncheckSome` events.
...
- **Detail:**
  ...
  Collapse all data if the detail view option is set to `true`.

- **Example:** [Expand/Collapse All Rows](https://examples.bootstrap-table.com/#methods/expand-collapse-all-data.html)
...
- **Detail:**
  ...
  Expand all data if the detail view option is set to `true`.
...
- **Detail:**
  ...
  * `includeHiddenRows`: if set to true the method will include the hidden data.
...
- **Detail:**
  ...
  Get all data hidden and if you pass the `show` parameter `true` the data will be shown again, otherwise, the method only will return the data hidden.

- **Example:** [Get Hidden Rows](https://examples.bootstrap-table.com/#methods/get-hidden-data.html)
...
- **Detail:**
  ...
  Return selected data, when no record selected, an empty array will return.
  The selected data will be unselected while some actions happens e.g. searching or page change, if you want to maintain the selections please use [maintainMetaData](https://bootstrap-table.com/docs/api/table-options/#maintainmetadata). 
...
- **Detail:**
  ...
  Load the `data` to table, the old data will be removed.
...
- **Detail:**
  ...
  * `field`: the field name of remove data. If `$index` is not in your fields, you can use this special field `$index` to remove data by row index.
  * `values`: the array of values for data which should be removed. If you use the special field `$index`, you can pass an array of indexes.
...
- **Detail:**
  ...
  - object
    -  Scroll to the unit (`px` or `data (index starts by 0)`)
...
- **Detail:**
  ...
  * `field`: name of the field used to find records.
  * `values`: array of values for data to uncheck.
